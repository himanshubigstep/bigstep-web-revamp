            ...
            {/* {reviews && reviews.length === 0 ? (
                ...
                <div id="controls-carousel" className='relative w-full h-full max-w-[1440px] mx-auto rounded-2xl md:p-8 md:px-16 mb-16'>
                    {reviews && reviews.sort((a:any, b:any) => a.id - b.id).map((item, index) => {
                        ...
                        return (
                            <div key={index} className={`max-w-[1140px] mx-auto relative dark:bg-black shadow-2xl bg-white rounded-2xl md:p-16 px-8 py-16 md:mt-0 mt-8 w-full md:h-[26rem] flex flex-col justify-between items-center gap-4 duration-700 ease-in-out ${index === currentIndex ? 'block' : 'hidden'}`}>
                                <div className='w-[100%]'>
                                    <blockquote className="relative">
                                        ...
                                        <div className='relative w-full max-w-[1080px] mx-auto flex flex-col justify-center items-center text-center'>
                                            <h2 className='text-3xl font-medium text-center mb-4'>{item?.attributes?.message_title}</h2>
                                            <p className='text-lg font-normal'>{item?.attributes?.message}</p>
                                        </div>
                                        <div className='w-[100%]'>
                                            {/* <img
