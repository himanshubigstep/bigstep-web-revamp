...
const Clients: React.FC<ClientProps> = ({ title, bgImage, description }) => {
    return (
        <div className='md:py-16 py-8 relative w-full max-w-[1440px] mx-auto h-full rounded-3xl'>
            <img
                src={bgImage}
                alt=''
                className='dark:invert rounded-3xl z-9 w-full h-full md:object-fill object-cover absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'
            />
