...
const TopBanner = ({ bannerData }: { bannerData: any }) => {
    ...
    const imageUrl = bannerData?.backgroundImage?.data
        ...
        : null;
    return (
        <div className='w-full relative lg:h-[80vh] md:h-[60vh] sm:h-screen h-[50vh] lg:px-4'>
            ...
            <div className='w-full max-w-[1440px] mx-auto h-full flex lg:justify-between lg:items-center gap-4 relative px-4'>
                <div className='lg:w-1/2 md:w-1/2 w-[80%] h-full flex flex-col lg:justify-center md:justify-center justify-end lg:pb-0 md:pb-0 pb-8 items-start gap-4'>
