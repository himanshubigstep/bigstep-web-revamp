'use client'
import { fetchModalBoxPropTechPage, fetchPropTechDevelopmentBenifits, fetchPropTechDevelopmentData, fetchPropTechDevelopmentFeatures, fetchPropTechDevelopmentTechData } from '@/api-data/api';
