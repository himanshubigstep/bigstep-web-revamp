'use client'
import { fetchHeaderData, fetchPropTechDevelopmentBenifits, fetchPropTechDevelopmentData, fetchPropTechDevelopmentFeatures, fetchPropTechDevelopmentTechData } from '@/api-data/api';
