...
import { fetchPropTechChallengesPage, fetchPropChallengesTypes } from '@/api-data/api'
...
const PropTechTechnologiesChallenges = () => {
  ...
  useEffect(() => {
    const fetchChallengesCategories = async () => {
      try {
        const response = await fetchPropChallengesTypes();
  ...
  useEffect(() => {
    const fetchAwsChallenges = async () => {
      try {
        const response = await fetchPropTechChallengesPage();
  ...
  return (
    <div className='poppins'>
      <ChallengingFormSection
        challengesFormButtonText="Get Free Prop Tech Assessment"
        challengescategories={challengescategories}
        challengesLabel="Prop Tech Challenges"
...
export default PropTechTechnologiesChallenges