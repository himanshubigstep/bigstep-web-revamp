'use client'
import { fetchHeaderData, fetchHomepageData, fetchProductEngineeringData, fetchServiceDataHome } from '@/api-data/api'
...
const ProductEngineering = () => {
  const [productEngineeringData, setProductEngineeringData] = useState<any>([]);
