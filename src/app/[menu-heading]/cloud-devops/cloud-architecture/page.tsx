'use client'
import { fetchCloudArchitechChooseUs, fetchCloudArchitechData, fetchCloudArchitechTech } from '@/api-data/api';
  ...
  return (
    <div className='poppins'>
      ...
      <AITech
        ...
        onButtonClick={cloudArchitechData?.blogs?.button_link || ''}
      />
      <Clients
